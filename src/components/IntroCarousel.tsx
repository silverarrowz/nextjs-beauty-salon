            ...
            >
              ...
              <button
               ...
               top-1/2 right-52 w-full sm:w-auto sm:mx-auto lg:text-lg bg-button-light
                ...
                hover:text-pink-900 hover:outline-pink-900 outline-1 outline outline-pink-900/40 transition-all duration-300 uppercase shadow-md p-2
          ...
          <Link href={"#form"}>
            ...
            >
              ...
              <button
                ...
                lg:top-1/2 lg:right-52 bg-white text-pink-950 outline outline-pink-900/40 outline-1
