...
const FooterSection = () => {
  ...
  return (
    <footer className="min-h-56 test py-6  lg:-mx-0 flex flex-col text-center justify-center items-center gap-4">
