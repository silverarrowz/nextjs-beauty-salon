const ContactsSection = () => {
  return (
    <div
      id="contact"
      className="flex flex-col items-center justify-center mb-12  lg:mx-0"
    >
      <h3 className="mb-4 text-xl">Адрес и контакты</h3>
      <hr className="mb-4 h-px w-3/5 border-t-0 bg-transparent bg-gradient-to-r max-w-48 from-transparent via-black to-transparent opacity-25 dark:via-neutral-400" />

      <p className="mb-4 text-sm">
        gombreichsalon@yandex.ru | +7 (939) 796-48-99
      </p>
